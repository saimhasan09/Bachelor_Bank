...
class UserRegistrationForm(UserCreationForm):
    ...
    class Meta:
        model = User  # Specify the model associated with the form
    ...
    # Override the save method to save additional data
    def save(self, commit=True):
        our_user = super().save(commit=False)  # Avoid saving the user immediately

        if commit:
            our_user.save()  # Save the user first

            # Create associated UserAddress and UserBankAccount objects
